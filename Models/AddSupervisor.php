...
class addSupervisorModel extends Model
{
    ...
    function loadEmployee($emp_id){
        ...
        $sql = "SELECT employee.emp_id, employee.firstname, department.dept_name FROM employee JOIN employment JOIN department
    ...
    function loadSupervisorsFromDept($dept_name, $emp_id){
        ...
        $sql = "SELECT employee.emp_id, employee.firstname FROM employee JOIN employment JOIN department
